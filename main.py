...
CHARGED is returned ONLY on Shopify ProcessedReceipt / SuccessfulReceipt (real order).
"""
...
app = FastAPI(title="Shopify Checkout API", version="2.0.0", docs_url=None, redoc_url=None)
...
<p>Returns <span class=ok>CHARGED</span> only when Shopify confirms a real order.</p>
